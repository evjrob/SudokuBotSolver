...
public class SudokuCellView extends TextView {
    ...
    public interface OnToggledListener {
        void OnToggled(SudokuCellView v, boolean touchOn);
    }
    ...
    public SudokuCellView(Context context, int x, int y) {
        super(context);
        idX = x;
        idY = y;
        init();
    ...
    public SudokuCellView(Context context, AttributeSet attrs, int defStyleAttr) {
